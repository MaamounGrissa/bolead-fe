...
export const PlanificationsFilter: React.FunctionComponent<{
  ...
  const onFilter = (repo: IPlanification) => {
    // Search titre with search value
  ...
  React.useEffect(() => {
    const filteredRepos = planifications.filter(onFilter);
    filterData(filteredRepos);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [searchValue, statusSelection, typeSelections, planifications]);
