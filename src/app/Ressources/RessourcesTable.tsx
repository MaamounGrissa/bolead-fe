...
export const RessourcesTable: React.FunctionComponent<{
    ...
    const fetchRessourceStatus = async () => {
        await axiosInstance?.current?.get(`services/inspections/api/referentiel-member-statuses`).then(response => {
    ...
    const fetchRessourceTypes = async () => {
        await axiosInstance?.current?.get(`services/inspections/api/teams`).then(response => {
    ...
    const fetchRessourcesList = async () => {
        await axiosInstance?.current?.get(`services/inspections/api/members`, {
            params: {
                page: page - 1,
                size: size,
                //sort: 'createdAt,desc',
