...
export const ProjetsTable: React.FunctionComponent<{
    ...
    const fetchProjetStatus = async () => {
        await axiosInstance?.current?.get(`services/inspections/api/referentiel-project-statuses`).then(response => {
    ...
    const fetchProjetTypes = async () => {
        await axiosInstance?.current?.get(`services/inspections/api/referentiel-project-types`).then(response => {
    ...
    const fetchProjetList = async () => {
        await axiosInstance?.current?.get(`services/inspections/api/projects`, {
            params: {
                page: page - 1,
                size: size,
                //sort: 'createdAt,desc',
